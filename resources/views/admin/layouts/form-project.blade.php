            ...
            <form action="{{ route('project.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="last_name"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <label class="block my-3 text-sm font-medium text-gray-900 dark:text-white" for="">Image</label>
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file1"
                        ...
                        <input id="dropzone-file1" type="file" name="image[]" class="hidden" />
                    </label>
                </div>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file2"
                        ...
                        <input id="dropzone-file2" type="file" name="image[]" class="hidden" />
                    </label>
                </div>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file3"
                        ...
                        <input id="dropzone-file3" name="image[]" type="file" class="hidden" />
                    </label>
                </div>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file4"
                        ...
                        <input id="dropzone-file4" type="file" name="image[]" class="hidden" />
                    </label>
                </div>
