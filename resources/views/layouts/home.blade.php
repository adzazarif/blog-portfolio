    ...
    <section id="achievements">
        <div class="bg-dark py-12">
            ...
            <div class="flex flex-col px-5 gap-5 items-center justify-center relative" id="contentPerlombaan">
                ...
                <p class="text-dark p-5 absolute text-[60px]  rotate-12 left-0 md:left-36 z-30 top-[-80px] "><i class="fa-solid fa-trophy"></i></p>
                <img src="{{ asset('image/bg-tp.png') }}" class="absolute top-[-220px] left-[-100px] mdleft-0" alt="">
            ...
            <div id="contentSertifikat" class="relative">
                <p class="text-dark p-5 absolute text-[60px]  rotate-12 left-0 md:left-36 z-30 top-[-80px] "><i class="fa-solid fa-trophy"></i></p>
                <img src="{{ asset('image/bg-tp.png') }}" class="absolute top-[-220px] left-[-100px] mdleft-0" alt="">
