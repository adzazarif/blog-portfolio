        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-white md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="flex items-center relative gap-5 w-100 py-52 px-5 md:px-24 justify-between bg-dark flex-col md:flex-row ">
            ...
            <div data-aos="fade-up-right" data-aos-once="true" class="z-30">
                ...
                <div class="flex gap-5">
                    ...
                    <i class="text-[35px] text-white fa-brands fa-linkedin"></i>
                    ...
                    <div class="w-full md:w-1/2">
                        <div class="flex flex-col justify-between h-full">
                            <div>
                                ...
                                <p class="text-slate-400 text-[15px]">Lorem ipsum dolor sit amet consectetur
                                    adipisicing
                                    elit. Nostrum
            ...
            <div class="md:w-2/3">
                ...
                <div data-aos="zoom-in-up" data-aos-once="true" data-aos-offset="-500" class="p-5 w-full inline-block bg-dark rounded-[20px]">
                    ...
                    <p class="text-slate-300 mt-2 text-[15px]">Ini pengalaman saya ketika mengikuti lomba IT Polinema
                        ...
                        saya
                        dengan tim cozifar team yang beranggotakan nico ,farhan, dan saya sendiri. Lorem ipsum dolor sit
                        amet consectetur adipisicing elit. Rem recusandae architecto atque quasi molestiae tempora
                        aliquam repellendus, aspernatur corporis et accusantium rerum necessitatibus consequatur,
                        delectus in fugit hic ullam explicabo enim quidem. Quidem, enim? Obcaecati blanditiis
                        voluptatibus nostrum, sint officia expedita, sit voluptates voluptate vitae repellat molestias
                        sapiente consequatur! Corporis eius, laboriosam nemo dignissimos, odit veniam nisi nihil
                        veritatis et architecto doloribus eaque reiciendis, suscipit maxime iste magnam fugiat corrupti.
                        Voluptatum rem dicta similique minima quae vero veritatis hic quasi magni obcaecati odit sint
                        perspiciatis sequi eligendi omnis voluptatibus laboriosam</p>
                    ...
                    <div class="flex mt-3 justify-between items-center">
                        ...
                        <div class="flex gap-5  items-center">
                            <p class="text-slate-300 text-[14px]"><i class="fa-solid fa-calendar-days"></i> 2 Oktober
                                2024
                            </p>
